...
///
/// \file
/// \brief This file implements a vlang-format tool that automatically formats
/// (fragments of) SystemVerilog code.
///
//===----------------------------------------------------------------------===//
...
int main(int argc, const char **argv) {
  ...
  for (StringMap<cl::Option *>::iterator I = Options.begin(), E = Options.end();
       I != E; ++I) {
    if (I->second->Category != &VlangFormatCategory && I->first() != "help" &&
        I->first() != "version")
