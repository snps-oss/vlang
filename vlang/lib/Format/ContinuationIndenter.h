...
#ifndef LLVM_VLANG_FORMAT_CONTINUATION_INDENTER_H
#define LLVM_VLANG_FORMAT_CONTINUATION_INDENTER_H
...
private:
  ...
  /// by vlang-format and string literals with escaped newlines.
...
struct ParenState {
  ...
  /// that vlang-format prefers similar breaks, i.e. breaks in the same
  /// parenthesis.
...
#endif // LLVM_VLANG_FORMAT_CONTINUATION_INDENTER_H
