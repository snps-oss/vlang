...
#ifndef LLVM_VLANG_FORMAT_FORMAT_H
#define LLVM_VLANG_FORMAT_FORMAT_H

#include "vlang/Frontend/FrontendAction.h"
#include "vlang/Tooling/Refactoring.h"
...
struct FormatStyle {
  ...
  /// vlang-format will respect the input's line breaking decisions within
  ...
  /// \brief If \c true, vlang-format detects whether function calls and
  /// definitions are formatted with one parameter per line.
  ///
  /// Each call can be bin-packed, one-per-line or inconclusive. If it is
  /// inconclusive, e.g. completely on one line, but a decision needs to be
  /// made, vlang-format analyzes whether there are other bin-packed cases in
  ...
  /// (e.g. a type or variable name), vlang-format formats as if the \c {} were
...
/// getPredefinedStyle().
/// \li "file" - Load style configuration from a file called '.vlang-format'
/// located in one of the parent directories of \c FileName or the current
/// directory if \c FileName is empty.
///
/// \param[in] StyleName Style name to interpret according to the description
/// above.
/// \param[in] FileName Path to start search for .vlang-format if \c StyleName
/// == "file".
...
#endif // LLVM_VLANG_FORMAT_FORMAT_H
