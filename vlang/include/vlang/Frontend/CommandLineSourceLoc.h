...
#ifndef LLVM_VLANG_FRONTEND_COMMANDLINESOURCELOC_H
#define LLVM_VLANG_FRONTEND_COMMANDLINESOURCELOC_H
...
namespace llvm {
  namespace cl {
    ...
    template<>
    class parser<vlang::ParsedSourceLocation>
      : public basic_parser<vlang::ParsedSourceLocation> {
    public:
      inline bool parse(Option &O, StringRef ArgName, StringRef ArgValue,
                 vlang::ParsedSourceLocation &Val);
    };

    bool
    parser<vlang::ParsedSourceLocation>::
