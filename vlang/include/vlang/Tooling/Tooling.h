//===--- Tooling.h - Framework for standalone Vlang tools -------*- C++ -*-===//
//
...
//===----------------------------------------------------------------------===//
//
//  This file implements functions to run vlang tools standalone instead
//  of running them as a plugin.
//
//  A VlangTool is initialized with a CompilationDatabase and a set of files
...
//
//  Example tools:
//  - running vlang -fsyntax-only over source code from an editor to get
//    fast syntax checks
//  - running match/replace tools over C++ code
//
//===----------------------------------------------------------------------===//

#ifndef LLVM_VLANG_TOOLING_TOOLING_H
#define LLVM_VLANG_TOOLING_TOOLING_H

#include "vlang/Basic/Diagnostic.h"
#include "vlang/Basic/FileManager.h"
#include "vlang/Basic/LLVM.h"
#include "vlang/Driver/Util.h"
#include "vlang/Frontend/FrontendAction.h"
#include "vlang/Tooling/ArgumentsAdjusters.h"
#include "vlang/Tooling/CompilationDatabase.h"
...
/// \brief Interface to process a vlang::CompilerInvocation.
///
...
public:
  ...
  virtual bool runInvocation(vlang::CompilerInvocation *Invocation,
                             FileManager *Files,
                             DiagnosticConsumer *DiagConsumer) = 0;
};

/// \brief Interface to generate vlang::FrontendActions.
///
/// Having a factory interface allows, for example, a new FrontendAction to be
/// created for each translation unit processed by VlangTool.  This class is
...
public:
  ...
  bool runInvocation(vlang::CompilerInvocation *Invocation, FileManager *Files,
                     DiagnosticConsumer *DiagConsumer);

  /// \brief Returns a new vlang::FrontendAction.
  ///
  /// The caller takes ownership of the returned action.
  virtual vlang::FrontendAction *create() = 0;
};

/// \brief Returns a new FrontendActionFactory for a given type.
///
/// T must derive from vlang::FrontendAction.
///
/// Example:
/// FrontendActionFactory *Factory =
///   newFrontendActionFactory<vlang::SyntaxOnlyAction>();
template <typename T>
...
public:
  ...
  /// \see vlang::FrontendAction::BeginSourceFileAction
  ...
  /// \see vlang::FrontendAction::EndSourceFileAction
...
///   vlang::ASTConsumer *newASTConsumer();
/// } Factory;
...
bool runToolOnCode(vlang::FrontendAction *ToolAction, const Twine &Code,
...
///
/// \return - True if 'ToolAction' was successfully executed.
bool runToolOnCodeWithArgs(vlang::FrontendAction *ToolAction, const Twine &Code,
...
/// \brief Utility to run a FrontendAction in a single vlang invocation.
class ToolInvocation {
 public:
  /// \brief Create a tool invocation.
  ///
  /// \param CommandLine The command line arguments to vlang. Note that vlang
  ...
  /// (see vlang driver implementation) or mapped in via mapVirtualFile.
  ...
  /// \brief Create a tool invocation.
  ///
  /// \param CommandLine The command line arguments to vlang.
  ...
  /// \brief Run the vlang invocation.
  ///
 ...
 private:
  ...
  bool runInvocation(const char *BinaryName,
                     vlang::driver::Compilation *Compilation,
                     vlang::CompilerInvocation *Invocation);
...
/// By default the class uses VlangSyntaxOnlyAdjuster to modify
...
class VlangTool {
 public:
  /// \brief Constructs a vlang tool to run over a list of files.
  ///
  ...
  VlangTool(const CompilationDatabase &Compilations,
            ArrayRef<std::string> SourcePaths);

  virtual ~VlangTool() { clearArgumentsAdjusters(); }
...
FrontendActionFactory *newFrontendActionFactory() {
  ...
  public:
    virtual vlang::FrontendAction *create() { return new T; }
  };
...
inline FrontendActionFactory *newFrontendActionFactory(
  ...
  public:
    ...
    virtual vlang::FrontendAction *create() {
      return new ConsumerFactoryAdaptor(ConsumerFactory, Callbacks);
    }

  private:
    class ConsumerFactoryAdaptor : public vlang::ASTFrontendAction {
    public:
      ConsumerFactoryAdaptor(FactoryT *ConsumerFactory,
                             SourceFileCallbacks *Callbacks)
        : ConsumerFactory(ConsumerFactory), Callbacks(Callbacks) {}

      vlang::ASTConsumer *CreateASTConsumer(vlang::CompilerInstance &,
                                            StringRef) {
    ...
    protected:
      virtual bool BeginSourceFileAction(CompilerInstance &CI,
        ...
        if (!vlang::ASTFrontendAction::BeginSourceFileAction(CI, Filename))
          return false;
        if (Callbacks != NULL)
      ...
      virtual void EndSourceFileAction() LLVM_OVERRIDE {
        ...
        vlang::ASTFrontendAction::EndSourceFileAction();
      }
...
#endif // LLVM_VLANG_TOOLING_TOOLING_H
