//===--- Refactoring.h - Framework for vlang refactoring tools --*- C++ -*-===//
//
...
#ifndef LLVM_VLANG_TOOLING_REFACTORING_H
#define LLVM_VLANG_TOOLING_REFACTORING_H

#include "vlang/Basic/SourceLocation.h"
#include "vlang/Tooling/Tooling.h"
...
///
/// This is a refactoring specific version of \see VlangTool. FrontendActions
/// passed to run() and runAndSave() should add replacements to
/// getReplacements().
class RefactoringTool : public VlangTool {
public:
  /// \see VlangTool::VlangTool.
...
#endif // end namespace LLVM_VLANG_TOOLING_REFACTORING_H
